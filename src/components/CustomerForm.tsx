    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-end sm:items-center justify-center">
      <div className="bg-white w-full sm:max-w-2xl sm:rounded-2xl rounded-t-2xl shadow-xl max-h-[90vh] flex flex-col">
        ...
        <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between shrink-0">
          <h3 className="font-semibold text-slate-900">{isEdit ? '编辑客户' : '新增客户'}</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div className="pt-2 border-t border-slate-100">
            <p className="text-xs text-slate-400 mb-2">跟进信息</p>
            <div className="grid grid-cols-2 gap-3">
              <Field label="最近跟进时间">
                <input
                  type="date"
          ...
          {/* 客户资料 */}
          <div className="pt-2 border-t border-slate-100">
            <p className="text-xs text-slate-400 mb-2">客户资料</p>
            <div className="grid grid-cols-2 gap-3">
              <Field label="信任人">
                <input
                  type="text"
